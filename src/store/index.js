...
import { studyPlanReducer, setStudyPlan, setPlan, setDegree, setMajor, setMinor1, setMinor2, addPlanItem, removePlanItem } from "./slices/studyPlanSlice";
...
export {
    ...
    setStudyPlan, setPlan, setDegree, setMajor, setMinor1, setMinor2, addPlanItem, removePlanItem
}