        ...
        <div>
            <div>
                <label>
                    ...
                    <input type="checkbox" name="M1/M2_2+" checked={checked["M1/M2_2+"]} onChange={handleCheckBoxChange} />
                </label>
            </div>
            <div>
                <label>
                    DSE English level 5 or above
                    <input type="checkbox" name="DSEENG5+" checked={checked["DSEENG5+"]} onChange={handleCheckBoxChange} />
                </label>
            </div>
        </div>
    )
